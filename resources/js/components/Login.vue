<template>
   <div id="login">
      ...
      <form action="/beeflix" method="get">
         ...
         <div class="login-input-area">
            ...
            <input class="input-info" type="password" placeholder="Password">
         </div>
         <br>
         <p>
            
            <input class="input-button-signin" type="submit" value="Sign-In" name="signin">
