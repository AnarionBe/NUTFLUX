   ...
   <div id="register">
      ...
      <form action="" method="post">
         ...
         <div>
            <span> 
                  <div class="avatar">  
                     <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" fill="rgba(46, 63, 95, 0.25)"
               ...
               <input class='registerinfo' type="text" name="pseudo" id="pseudo" placeholder="Pseudo">
            </span>
         </div>
         <div class="error">
            <p class="alert alert-danger" v-if="seen"> Please fill all fields </p>
         </div>
         <input @click.prevent='createAccount()' type="button" value="Register" class='input-button'>
